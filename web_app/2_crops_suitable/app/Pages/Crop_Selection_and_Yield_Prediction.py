...
with col1:
    ...
    Photoperiod = st.multiselect("Photoperiod", ["Day Neutral", "Long Day Period", "Short Day Period"])
    NPKRatio = st.multiselect("N-P-K Ratio", ["5:10:05", "5:10:10", "6:06:06", "8:15:36", "10:10:05", "10:10:10", "13:13:13", "20:10:20", "22:12:13", "75:37.5:37.5"])
    Temperature = st.number_input("Temperature", min_value=10.00, max_value=40.00, help="")     
    Rainfall    = st.number_input("Rainfall", min_value=400.00, max_value=2800.00, help="")
    Light_Hours = st.number_input("Light_Hours", min_value=5.00, max_value=30.00, help="")
    Light_Intensity  = st.number_input("Light_Intensity", min_value=50.00, max_value=1200.00, help="")
...
with col2:
    ...
    Phosphorus  = st.number_input("Phosphorus", min_value=20.00, max_value=300.00, help="")
    Potassium  = st.number_input("Potassium", min_value=30.00, max_value=300.00, help="")
    Category_pH = st.multiselect("Category_pH", ["acidic", "low_acidic", "low_alkaline", "neutral"] ) 
